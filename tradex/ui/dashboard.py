...
tab_scanner, tab_coil, tab_confluence, tab_pattern, tab_premarket, tab_options, tab_alerts, tab_journal, tab_help = st.tabs([
    "Scanner", "Coil Detector", "Confluence", "Pattern Match",
    "Pre-Market", "Options Flow", "Alerts", "Signal Journal", "Help",
])
