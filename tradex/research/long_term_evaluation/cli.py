...
from .models import LONG_TERM_UNIVERSE, LongTermStudySpec, load_manifest
...
def _make_spec(args: argparse.Namespace) -> LongTermStudySpec:
    ...
    return LongTermStudySpec(
        ...
        hold_weeks=tuple(int(h) for h in args.hold_weeks.split(",")),
    )
...
def main(argv: list[str] | None = None) -> int:
    ...
    snap.add_argument("--warmup-weeks", type=int, default=50)
    ...
    evalp.add_argument("--warmup-weeks", type=int, default=50)
