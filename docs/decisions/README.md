...
| ID | Title | Status | Recorded | Notes |
|---|---|---|---|---|
| [ADR-0000](0000-template.md) | ADR Template | — | — | Copy this template for new ADRs |
| [ADR-0001](0001-market-timezone.md) | Market Timezone and Session Calendar | Accepted | 2026-08-04 | NYSE (`XNYS`) in `America/New_York` |
| [ADR-0002](0002-ohlcv-provider-contract.md) | OHLCV Provider Contract and Error Taxonomy | Accepted | 2026-08-04 | Universal columns; Schwab enforces UTC index |
| [ADR-0003](0003-coil-definition.md) | Coil Definition and Detection | Accepted | 2026-08-04 | Pre-signal heuristic, not a trade instruction |
| [ADR-0004](0004-confluence-scoring.md) | Cross-Timeframe Confluence Scoring | Accepted | 2026-08-04 | Coverage-aware aggregation |
