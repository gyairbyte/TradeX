...
- **Rapid-upside long opportunity research (LONG-002)** — A separate, new research program (`docs/research/LONG-002.md` and `docs/research/specs/LONG-002-v1.json`) studies +10%/+20%/+30% moves over 5/10/21 sessions for U.S. mid-/large-/mega-cap common stocks. `LONG-002A` is research-only/preregistration; `production_promotion_eligible=false`; historical holdout support authorizes only `LONG-002J` prospective shadow, and a `prospectively_supported` shadow authorizes only a separate Gary-approved production decision-support PR.
