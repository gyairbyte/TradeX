...
| `tradex/product/mvp_arch_001.py` | Design-only product consolidation decision-packet generator (MVP-ARCH-001). |
| `docs/product/MVP-ARCH-001.md` | Human-readable TradeX provider/strategy/dashboard consolidation plan. |
| `docs/product/MVP-ARCH-001.json` | Machine-readable MVP consolidation inventory and disposition. |
...
- **Product consolidation (MVP-ARCH-001)** — `docs/product/MVP-ARCH-001.md` records the design-only audit and bounded consolidation plan. All final decisions remain `pending_gary_decision`; the packet does not implement consolidation, remove providers, change dashboard tabs, alter alerts, migrate data, or begin `LONG-002C`.
