...
| `docs/research/INTRA-001-SPEC.md` | Pre-registered research specification for the long open-drive VWAP pullback continuation study; implementation is paused until the approved `SHORT-001` Schwab real-data study is completed. |
